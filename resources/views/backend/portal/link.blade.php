<div id="link">
    ...
    <div class="row">
        ...
        <div class="custom-modal-footer">
            ...
            &nbsp;&nbsp;<button type="submit" class="btn btn-sm btn-primary btn-link"><i class="fa fa-save"></i> Simpan</button>
        </div>
    </div>
    {!! Form::close() !!}
</div>
<div class="row">
	<div class="col-md-12">
        ...
        <div id="output"></div>
        <div class="progress">
            <div class="progress-bar-link" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
